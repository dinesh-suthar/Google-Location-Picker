            	...
            	<table class="table table-striped table-responsive table-hover">
                	...
                	<tr>
                    	...
                    	<?php
                        	...
                        	$q=mysql_query("select * from user_registration where verified='0'");
							...
							$_SESSION['last_page']=$_SERVER['REQUEST_URI'];//storing last page url in session
